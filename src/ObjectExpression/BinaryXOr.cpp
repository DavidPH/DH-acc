...
public:
   ...
   ObjectExpression_BinaryXOr(ObjectLoad &arc) : Super(arc) {}
...
protected:
   ...
   {
      return Super::save(arc << OT_BINARY_XOR);
   }
};
...
//
// ObjectExpression::LoadBinaryXOr
//
auto ObjectExpression::LoadBinaryXOr(ObjectLoad &arc) -> Reference
{
