...
public:
   enum BinaryCode
   {
      ...
      BCODE_SETOP_AND_STATIC  = 129,
      BCODE_SETOP_AND_AUTO    = 130,
      BCODE_SETOP_AND_POINTER = 131,
      BCODE_SETOP_IOR_STATIC  = 132,
      BCODE_SETOP_IOR_AUTO    = 133,
      BCODE_SETOP_IOR_POINTER = 134,
      BCODE_SETOP_XOR_STATIC  = 135,
      BCODE_SETOP_XOR_AUTO    = 136,
      BCODE_SETOP_XOR_POINTER = 137,
      BCODE_SETOP_LSH_STATIC  = 138,
      BCODE_SETOP_LSH_AUTO    = 139,
      BCODE_SETOP_LSH_POINTER = 140,
      BCODE_SETOP_RSH_STATIC  = 141,
      BCODE_SETOP_RSH_AUTO    = 142,
      BCODE_SETOP_RSH_POINTER = 143,
      BCODE_ADDR_AUTO         = 144,
      BCODE_ADDR_STACK_ADD    = 145,
      BCODE_ADDR_STACK_SUB    = 146,
      BCODE_BRANCH_GOTO       = 147,
