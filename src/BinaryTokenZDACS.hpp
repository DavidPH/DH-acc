...
public:
	enum BinaryCode
	{
		...
		BCODE_GET_ACTOR_X         = 196,
		BCODE_GET_ACTOR_Y         = 197,
		BCODE_GET_ACTOR_Z         = 198,
		BCODE_CALLZDACS           = 203,
		...
		BCODE_SET_ACTOR_PROPERTY  = 245,
		BCODE_GET_ACTOR_PROPERTY  = 246,
		BCODE_PLAYER_NUMBER       = 247,
		BCODE_ACTIVATOR_TID       = 248,
		BCODE_STRLEN              = 253,
		BCODE_SETRESULTVALUE      = 257,
		BCODE_GET_ACTOR_ANGLE     = 260,
		BCODE_LSPEC5RESULT        = 263,
		BCODE_ENDLOG              = 270,
		BCODE_GET_AMMO_CAPACITY   = 271,
		BCODE_SET_AMMO_CAPACITY   = 272,
		BCODE_SET_ACTOR_ANGLE     = 276,
		BCODE_SPAWN_PROJECTILE    = 280,
		BCODE_SET_ACTOR_POSITION  = 283,
		BCODE_NOT                 = 330,
		BCODE_GET_ACTOR_PITCH     = 331,
		BCODE_SET_ACTOR_PITCH     = 332,
		BCODE_PRINTHEX            = 350,
